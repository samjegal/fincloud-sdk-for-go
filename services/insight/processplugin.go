...
func (client ProcessPluginClient) Create(ctx context.Context, parameters ProcessPluginParameter) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "Create", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "Create", resp, "Failure responding to request")
	}
...
func (client ProcessPluginClient) Get(ctx context.Context, instanceNo string) (result ProcessPluginParameter, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "Get", resp, "Failure responding to request")
	}
...
func (client ProcessPluginClient) List(ctx context.Context) (result ListProcessPluginParameter, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insight.ProcessPluginClient", "List", resp, "Failure responding to request")
	}
