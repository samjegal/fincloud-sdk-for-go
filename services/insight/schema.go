...
// Parameters:
// prodName - product 이름
func (client SchemaClient) Create(ctx context.Context, prodName string) (result autorest.Response, err error) {
	...
	req, err := client.CreatePreparer(ctx, prodName)
	if err != nil {
...
func (client SchemaClient) CreatePreparer(ctx context.Context, prodName string) (*http.Request, error) {
