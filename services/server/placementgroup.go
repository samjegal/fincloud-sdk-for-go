...
func (client PlacementGroupClient) Add(ctx context.Context, placementGroupNo string, serverInstanceNo string) (result PlacementGroupServerInstanceAddResponse, err error) {
	...
	req, err := client.AddPreparer(ctx, placementGroupNo, serverInstanceNo)
	if err != nil {
...
func (client PlacementGroupClient) AddPreparer(ctx context.Context, placementGroupNo string, serverInstanceNo string) (*http.Request, error) {
	...
	signature, err := sec.Signature("POST", common.GetPath(DefaultBaseURI, "/addPlacementGroupServerInstance")+"?"+common.GetQuery(queryParameters), client.Client.AccessKey, timestamp)
	if err != nil {
		return nil, err
	}
...
func (client PlacementGroupClient) Create(ctx context.Context, placementGroupName string, placementGroupTypeCode string) (result PlacementGroupCreateResponse, err error) {
	...
	req, err := client.CreatePreparer(ctx, placementGroupName, placementGroupTypeCode)
	if err != nil {
...
func (client PlacementGroupClient) CreatePreparer(ctx context.Context, placementGroupName string, placementGroupTypeCode string) (*http.Request, error) {
	queryParameters := map[string]interface{}{
		"responseFormatType": autorest.Encode("query", "json"),
	}
	...
	timestamp := strconv.FormatInt(time.Now().UnixNano()/int64(time.Millisecond), 10)
	sec := security.NewSignature(client.Client.Secretkey, crypto.SHA256)
	signature, err := sec.Signature("POST", common.GetPath(DefaultBaseURI, "/createPlacementGroup")+"?"+common.GetQuery(queryParameters), client.Client.AccessKey, timestamp)
	if err != nil {
		return nil, err
	}
...
func (client PlacementGroupClient) Delete(ctx context.Context, placementGroupNo string) (result PlacementGroupDeleteResponse, err error) {
	...
	req, err := client.DeletePreparer(ctx, placementGroupNo)
	if err != nil {
...
func (client PlacementGroupClient) DeletePreparer(ctx context.Context, placementGroupNo string) (*http.Request, error) {
	queryParameters := map[string]interface{}{
		"placementGroupNo":   autorest.Encode("query", placementGroupNo),
		"responseFormatType": autorest.Encode("query", "json"),
	}
	...
	timestamp := strconv.FormatInt(time.Now().UnixNano()/int64(time.Millisecond), 10)
	sec := security.NewSignature(client.Client.Secretkey, crypto.SHA256)
	signature, err := sec.Signature("POST", common.GetPath(DefaultBaseURI, "/deletePlacementGroup")+"?"+common.GetQuery(queryParameters), client.Client.AccessKey, timestamp)
	if err != nil {
		return nil, err
	}
...
// Parameters:
// placementGroupNo - 물리 배치 그룹 번호
func (client PlacementGroupClient) GetDetail(ctx context.Context, placementGroupNo string) (result PlacementGroupDetailResponse, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetDetailPreparer(ctx, placementGroupNo)
	if err != nil {
...
func (client PlacementGroupClient) GetDetailPreparer(ctx context.Context, placementGroupNo string) (*http.Request, error) {
	queryParameters := map[string]interface{}{
		"responseFormatType": autorest.Encode("query", "json"),
	}
	...
	timestamp := strconv.FormatInt(time.Now().UnixNano()/int64(time.Millisecond), 10)
	sec := security.NewSignature(client.Client.Secretkey, crypto.SHA256)
	signature, err := sec.Signature("GET", common.GetPath(DefaultBaseURI, "/getPlacementGroupDetail")+"?"+common.GetQuery(queryParameters), client.Client.AccessKey, timestamp)
	if err != nil {
		return nil, err
	}
...
func (client PlacementGroupClient) GetList(ctx context.Context, placementGroupName string, placementGroupNoListN string) (result PlacementGroupListResponse, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetListPreparer(ctx, placementGroupName, placementGroupNoListN)
	if err != nil {
...
func (client PlacementGroupClient) GetListPreparer(ctx context.Context, placementGroupName string, placementGroupNoListN string) (*http.Request, error) {
	queryParameters := map[string]interface{}{
		"responseFormatType": autorest.Encode("query", "json"),
	}
	...
	timestamp := strconv.FormatInt(time.Now().UnixNano()/int64(time.Millisecond), 10)
	sec := security.NewSignature(client.Client.Secretkey, crypto.SHA256)
	signature, err := sec.Signature("GET", common.GetPath(DefaultBaseURI, "/getPlacementGroupList")+"?"+common.GetQuery(queryParameters), client.Client.AccessKey, timestamp)
	if err != nil {
		return nil, err
	}
...
func (client PlacementGroupClient) Remove(ctx context.Context, placementGroupNo string, serverInstanceNo string) (result PlacementGroupServerInstanceRemoveResponse, err error) {
	...
	req, err := client.RemovePreparer(ctx, placementGroupNo, serverInstanceNo)
	if err != nil {
...
func (client PlacementGroupClient) RemovePreparer(ctx context.Context, placementGroupNo string, serverInstanceNo string) (*http.Request, error) {
	queryParameters := map[string]interface{}{
		"placementGroupNo":   autorest.Encode("query", placementGroupNo),
		"responseFormatType": autorest.Encode("query", "json"),
		"serverInstanceNo":   autorest.Encode("query", serverInstanceNo),
	...
	timestamp := strconv.FormatInt(time.Now().UnixNano()/int64(time.Millisecond), 10)
	sec := security.NewSignature(client.Client.Secretkey, crypto.SHA256)
	signature, err := sec.Signature("POST", common.GetPath(DefaultBaseURI, "/removePlacementGroupServerInstance")+"?"+common.GetQuery(queryParameters), client.Client.AccessKey, timestamp)
	if err != nil {
		return nil, err
	}
