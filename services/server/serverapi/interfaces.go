...
type ACGClientAPI interface {
	Create(ctx context.Context, vpcNo string, accessControlGroupName string, accessControlGroupDescription string) (result server.AccessControlGroupCreateResponse, err error)
	Delete(ctx context.Context, vpcNo string, accessControlGroupNo string) (result server.AccessControlGroupDeleteResponse, err error)
...
type ACGOutboundClientAPI interface {
	AddRule(ctx context.Context, vpcNo string, accessControlGroupNo string, accessControlGroupRuleListNprotocolTypeCode server.ProtocolTypeCode, accessControlGroupRuleListNipBlock string, accessControlGroupRuleListNaccessControlGroupSequence string, accessControlGroupRuleListNportRange string, accessControlGroupRuleListNaccessControlGroupRuleDescription string) (result server.AccessControlGroupOutboundRuleAddResponse, err error)
...
type ZoneClientAPI interface {
	GetList(ctx context.Context) (result server.ZoneListResponse, err error)
}
...
type InitScriptClientAPI interface {
	Create(ctx context.Context, initScriptContent string, osTypeCode server.OsTypeCode, initScriptName string, initScriptDescription string) (result server.InitScriptCreateResponse, err error)
	Delete(ctx context.Context, initScriptNoListN string) (result server.InitScriptDeleteResponse, err error)
...
type LoginKeyClientAPI interface {
	Create(ctx context.Context, keyName string) (result server.LoginKeyCreateResponse, err error)
	Delete(ctx context.Context, keyNameListN string) (result server.LoginKeysDeleteResponse, err error)
	GetList(ctx context.Context, pageNo string, pageSize string) (result server.LoginKeyListResponse, err error)
	Import(ctx context.Context, publicKey string, keyName string) (result server.LoginKeyImportResponse, err error)
}
...
type NetworkInterfaceClientAPI interface {
	AddACG(ctx context.Context, networkInterfaceNo string, accessControlGroupNoListN string) (result server.NetworkInterfaceAccessControlGroupAddResponse, err error)
	Attach(ctx context.Context, subnetNo string, networkInterfaceNo string, serverInstanceNo string) (result server.NetworkInterfaceAttachResponse, err error)
	Create(ctx context.Context, vpcNo string, subnetNo string, networkInterfaceName string, accessControlGroupNoListN string, serverInstanceNo string, IP string, networkInterfaceDescription string) (result server.NetworkInterfaceCreateResponse, err error)
	Delete(ctx context.Context, networkInterfaceNo string) (result server.NetworkInterfaceDeleteResponse, err error)
	Detach(ctx context.Context, subnetNo string, networkInterfaceNo string, serverInstanceNo string) (result server.NetworkInterfaceDetachResponse, err error)
	...
	RemoveACG(ctx context.Context, networkInterfaceNo string, accessControlGroupNoListN string) (result server.NetworkInterfaceAccessControlGroupRemoveResponse, err error)
}
...
type PlacementGroupClientAPI interface {
	Add(ctx context.Context, placementGroupNo string, serverInstanceNo string) (result server.PlacementGroupServerInstanceAddResponse, err error)
	Create(ctx context.Context, placementGroupName string, placementGroupTypeCode string) (result server.PlacementGroupCreateResponse, err error)
	Delete(ctx context.Context, placementGroupNo string) (result server.PlacementGroupDeleteResponse, err error)
	...
	Remove(ctx context.Context, placementGroupNo string, serverInstanceNo string) (result server.PlacementGroupServerInstanceRemoveResponse, err error)
}
...
type PublicIPClientAPI interface {
	Associate(ctx context.Context, publicIPInstanceNo string, serverInstanceNo string) (result server.PublicIPWithServerInstanceAssociateResponse, err error)
	Create(ctx context.Context, serverInstanceNo string, publicIPDescription string) (result server.PublicIPInstanceCreateResponse, err error)
	Delete(ctx context.Context, publicIPInstanceNo string) (result server.PublicIPInstanceDeleteResponse, err error)
	Disassociate(ctx context.Context, publicIPInstanceNo string, serverInstanceNo string) (result server.PublicIPFromServerInstanceDisassociateResponse, err error)
...
type ClientAPI interface {
	...
	Reboot(ctx context.Context, serverInstanceNoListN string) (result server.InstancesRebootResponse, err error)
	Start(ctx context.Context, serverInstanceNoListN string) (result server.InstancesStartResponse, err error)
	Stop(ctx context.Context, serverInstanceNoListN string) (result server.InstancesStopResponse, err error)
	Terminate(ctx context.Context, serverInstanceNoListN string) (result server.InstancesTerminateResponse, err error)
}
...
type RootPasswordClientAPI interface {
	Get(ctx context.Context, serverInstanceNo string, privateKey string) (result server.RootPasswordResponse, err error)
...
type ImageClientAPI interface {
	Create(ctx context.Context, serverInstanceNo string, memberServerImageName string, memberServerImageDescription string) (result server.MemberServerImageInstanceCreateResponse, err error)
	Delete(ctx context.Context, memberServerImageInstanceNoListN string) (result server.MemberServerImageInstanceDeleteResponse, err error)
	GetDetail(ctx context.Context, memberServerImageInstanceNo string) (result server.MemberServerImageInstanceDetailResponse, err error)
...
type SnapshotClientAPI interface {
	Create(ctx context.Context, originalBlockStorageInstanceNo string, blockStorageSnapshotName string, blockStorageSnapshotDescription string) (result server.BlockStorageSnapshotInstanceCreateResponse, err error)
	Delete(ctx context.Context, blockStorageSnapshotInstanceNoListN string) (result server.BlockStorageSnapshotInstanceDeleteResponse, err error)
...
type BlockStorageClientAPI interface {
	Attach(ctx context.Context, blockStorageInstanceNo string, serverInstanceNo string) (result server.BlockStorageInstanceAttachResponse, err error)
	...
	Delete(ctx context.Context, blockStorageInstanceNoListN string) (result server.BlockStorageInstanceDeleteResponse, err error)
	Detach(ctx context.Context, blockStorageInstanceNoListN string) (result server.BlockStorageInstanceDetachResponse, err error)
