...
func (client RouteTableSubnetClient) Add(ctx context.Context, responseFormatType string, vpcNo string, routeTableNo string, subnetNoListN string, regionCode string) (result autorest.Response, err error) {
...
func (client RouteTableSubnetClient) AddResponder(resp *http.Response) (result autorest.Response, err error) {
...
// GetList 라우트 테이블에 연���된 서브넷 리스트를 조회
// Parameters:
// responseFormatType - 반환 데이터 포맷 타입
// routeTableNo - 라우트 테이블 번호
// regionCode - REGION 코드
func (client RouteTableSubnetClient) GetList(ctx context.Context, responseFormatType string, routeTableNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client RouteTableSubnetClient) GetListResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// subnetNoListN - 서브넷 번호 리스트
// regionCode - REGION 코드
func (client RouteTableSubnetClient) Remove(ctx context.Context, responseFormatType string, vpcNo string, routeTableNo string, subnetNoListN string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client RouteTableSubnetClient) RemoveResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
