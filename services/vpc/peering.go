...
func (client PeeringClient) AcceptOrReject(ctx context.Context, responseFormatType string, vpcPeeringInstanceNo string, isAccept string, regionCode string) (result autorest.Response, err error) {
...
func (client PeeringClient) AcceptOrRejectResponder(resp *http.Response) (result autorest.Response, err error) {
...
func (client PeeringClient) Create(ctx context.Context, responseFormatType string, sourceVpcNo string, targetVpcNo string, regionCode string, vpcPeeringName string, targetVpcName string, targetVpcLoginID string, vpcPeeringDescription string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client PeeringClient) CreateResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// vpcPeeringInstanceNo - VPC Peering 인스턴스 번호
// regionCode - REGION 코드
func (client PeeringClient) Delete(ctx context.Context, responseFormatType string, vpcPeeringInstanceNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client PeeringClient) DeleteResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
