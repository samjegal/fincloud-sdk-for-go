...
func (client SubnetClient) Create(ctx context.Context, responseFormatType string, zoneCode string, vpcNo string, subnet string, networkACLNo string, subnetTypeCode SubnetTypeCode, regionCode string, subnetName string, usageTypeCode UsageTypeCode) (result autorest.Response, err error) {
...
func (client SubnetClient) CreateResponder(resp *http.Response) (result autorest.Response, err error) {
...
// subnetNo - 서브넷 번호
// regionCode - REGION 코드
func (client SubnetClient) Delete(ctx context.Context, responseFormatType string, subnetNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client SubnetClient) DeleteResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// subnetNo - 서브넷 번호
// regionCode - REGION 코드
func (client SubnetClient) GetDetail(ctx context.Context, responseFormatType string, subnetNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client SubnetClient) GetDetailResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// closes the http.Response Body.
func (client SubnetClient) GetListResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
