...
// vpcName - VPC 이름
func (client Client) Create(ctx context.Context, ipv4CidrBlock string, responseFormatType string, regionCode string, vpcName string) (result autorest.Response, err error) {
...
// responseFormatType - 반환 데이터 포맷 타입
// regionCode - REGION 코드
func (client Client) Delete(ctx context.Context, vpcNo string, responseFormatType string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// responseFormatType - 반환 데이터 포맷 타입
// regionCode - REGION 코드
func (client Client) GetDetail(ctx context.Context, vpcNo string, responseFormatType string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client Client) GetList(ctx context.Context, responseFormatType string, regionCode string, vpcStatusCode StatusCode, vpcName string, vpcNoListN string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
