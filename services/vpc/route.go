...
func (client RouteClient) Add(ctx context.Context, responseFormatType string, vpcNo string, routeTableNo string, routeListNdestinationCidrBlock string, routeListNtargetTypeCode TargetTypeCode, routeListNtargetNo string, routeListNtargetName string, regionCode string) (result autorest.Response, err error) {
...
func (client RouteClient) AddResponder(resp *http.Response) (result autorest.Response, err error) {
...
// vpcNo - VPC 번호
// regionCode - REGION 코드
func (client RouteClient) GetList(ctx context.Context, responseFormatType string, routeTableNo string, vpcNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client RouteClient) GetListResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// routeListNtargetName - 목적지 이름
// regionCode - REGION 코드
func (client RouteClient) Remove(ctx context.Context, responseFormatType string, vpcNo string, routeTableNo string, routeListNdestinationCidrBlock string, routeListNtargetTypeCode TargetTypeCode, routeListNtargetNo string, routeListNtargetName string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client RouteClient) RemoveResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
