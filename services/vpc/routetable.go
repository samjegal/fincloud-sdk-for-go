...
func (client RouteTableClient) Create(ctx context.Context, responseFormatType string, vpcNo string, regionCode string, routeTableName string, supportedSubnetTypeCode SupportedSubnetTypeCode, routeTableDescription string) (result autorest.Response, err error) {
...
// regionCode - REGION 코드
func (client RouteTableClient) Delete(ctx context.Context, responseFormatType string, routeTableNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// routeTableNo - 라우트 테이블 번호
// regionCode - REGION 코드
func (client RouteTableClient) GetDetail(ctx context.Context, responseFormatType string, routeTableNo string, regionCode string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client RouteTableClient) GetDetailResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// closes the http.Response Body.
func (client RouteTableClient) GetListResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
