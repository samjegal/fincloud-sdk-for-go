...
type ClientAPI interface {
	...
	RemoveAccessControl(ctx context.Context, nasVolumeInstanceNo string, serverInstanceNoListN string) (result nas.VolumeAccessControlRemoveResponse, err error)
	SetAccessControl(ctx context.Context, nasVolumeInstanceNo string, serverInstanceNoListN string) (result nas.VolumeAccessControlSetResponse, err error)
}
