...
type BaseBlockStorageDiskDetailTypeParameter = original.BaseBlockStorageDiskDetailTypeParameter
type BaseBlockStorageDiskTypeParameter = original.BaseBlockStorageDiskTypeParameter
...
type InstanceListResponseParameter = original.InstanceListResponseParameter
type InstanceOperationParameter = original.InstanceOperationParameter
type InstanceStatusParameter = original.InstanceStatusParameter
type InstanceTypeParameter = original.InstanceTypeParameter
type LoginKeyClient = original.LoginKeyClient
type NetworkInterfaceClient = original.NetworkInterfaceClient
type NetworkInterfaceNoListParameter = original.NetworkInterfaceNoListParameter
type PlacementGroupClient = original.PlacementGroupClient
type PlatformTypeParameter = original.PlatformTypeParameter
